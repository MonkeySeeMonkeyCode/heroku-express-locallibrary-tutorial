...
exports.bookinstance_delete_post = function(req, res) {
    ...
    .exec(function (err, bookinstance) {
        if (err) { return next(err); }
        BookInstance.findByIdAndRemove(req.body.bookisntanceid, function deleteAuthor(err) {
            if (err) { return next(err); }
...
exports.bookinstance_update_post = [
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            // Get all books and book instances for form.
            async.parallel({
                book: function(callback) {
                    Book.find({},'title').exec(callback)
                },
                ...
                // Success.
                res.render('bookinstance_form', {title: 'Update Book Instance', book_list: results.book, selected_book: bookinstance._id, bookinstance: bookinstance } );
            });
        }
        else {
